  ...
  return (
    ...
    >
      <div ref={heroRef} style={{ maxWidth: 760, margin: "0 auto", padding: "0 24px" }}>
        ...
        >
          Theo doi chat luong khong khi thoi gian thuc voi do chinh xac tuyet doi tu ve tinh va
          mang luoi cam bien cong dong.
        </p>
        ...
        {aqiData.map((item, i) => (
          ...
          >
            ...
            <div style={{ marginBottom: 8 }}>
              <span style={{ fontSize: 40, fontWeight: 800, color: item.aqiColor, lineHeight: 1 }}>
                {item.aqi}
              </span>
              <span style={{ fontSize: 13, color: item.aqiColor, fontWeight: 500, marginLeft: 4 }}>
                AQI
              </span>
            </div>
