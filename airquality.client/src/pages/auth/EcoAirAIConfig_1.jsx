      ...
      <div style={{ display: "flex", justifyContent: "flex-end", marginBottom: 24 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 24 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 8, background: "#fff", borderRadius: 8, padding: "7px 14px", width: 240, border: "1px solid #e5e7eb" }}>
            ...
            <input placeholder="Tìm kiếm tham số..." style={{ background: "transparent", border: "none", outline: "none", fontSize: 13, width: "100%" }} />
          </div>
          <div style={{ display: "flex", gap: 4, background: "#fff", padding: 4, borderRadius: 8, border: "1px solid #e5e7eb" }}>
            ...
            <div style={{ padding: "6px 16px", fontSize: 13, fontWeight: 700, color: "#1a7a4a", background: "#e8f5ec", borderRadius: 6, cursor: "pointer" }}>Phân tích AI</div>
          </div>
        </div>
      </div>
