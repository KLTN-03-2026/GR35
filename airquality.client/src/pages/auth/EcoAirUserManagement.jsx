      ...
      <aside style={{ width: 200, background: "#fff", borderRight: "1px solid #e5e7eb", display: "flex", flexDirection: "column", padding: "0 0 24px 0", flexShrink: 0, position: "fixed", top: 0, left: 0, height: "100vh" }}>
        ...
        <nav style={{ flex: 1, padding: "12px 0" }}>
          {[
            ...
            { icon: "👥", label: "Người dùng", active: true },
            { icon: "📡", label: "Trạm bo", active: false },
        ...
        <div style={{ borderTop: "1px solid #e5e7eb", paddingTop: 12 }}>
          {[{ icon: "👤", label: "Hồ sơ" }, { icon: "↩", label: "Đăng xuất" }].map((item) => (
      ...
      <div style={{ marginLeft: 200, flex: 1, display: "flex", flexDirection: "column" }}>
        ...
        <header style={{ background: "#fff", borderBottom: "1px solid #e5e7eb", display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0 28px", height: 56, position: "sticky", top: 0, zIndex: 50 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 24 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 8, background: "#f3f4f6", borderRadius: 8, padding: "7px 14px", width: 240 }}>
              ...
              <span style={{ fontSize: 13, color: "#9ca3af" }}>Tìm kiếm nhật ký hệ thống...</span>
            </div>
            <div style={{ display: "flex", gap: 4 }}>
              <div style={{ padding: "6px 16px", fontSize: 13, fontWeight: 500, color: "#6b7280", cursor: "pointer" }}>Tổng quan</div>
              <div style={{ padding: "6px 16px", fontSize: 13, fontWeight: 700, color: "#1a7a4a", borderBottom: "2px solid #1a7a4a", cursor: "pointer" }}>Dữ liệu khu vực</div>
            </div>
          </div>
          <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
              <div style={{ width: 34, height: 34, borderRadius: "50%", background: "#d1fae5", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 16 }}>👩</div>
              <svg width="18" height="18" viewBox="0 0 18 18" fill="none"><rect x="2" y="2" width="6" height="6" rx="1.5" fill="#9ca3af"/><rect x="10" y="2" width="6" height="6" rx="1.5" fill="#9ca3af"/><rect x="2" y="10" width="6" height="6" rx="1.5" fill="#9ca3af"/><rect x="10" y="10" width="6" height="6" rx="1.5" fill="#9ca3af"/></svg>
            </div>
          </div>
        </header>

        {/* PAGE CONTENT */}
        <div style={{ padding: "32px 28px 40px", flex: 1 }}>
