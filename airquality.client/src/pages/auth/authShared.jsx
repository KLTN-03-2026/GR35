...
export function InputField({ label, type = "text", placeholder, value, onChange, onKeyDown, error, icon, rightElement }) {
  return (
    <div style={{ marginBottom: 16 }}>
      ...
      <div style={{ position: "relative" }}>
        ...
        <input
          ...
          style={{
            width: "100%",
            padding: icon ? "11px 42px 11px 40px" : (rightElement ? "11px 42px 11px 14px" : "11px 14px"),
